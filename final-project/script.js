...
(function() {
    var wear = [{
        ...
        { "name": "Insights", "description": "10 equipos profesionales", "count": "283 jugadores", "wear": "./img/oceania.jpeg", "see_more": "oceania.html" }
    ]
    ...
    function buildCard(portfolio) {
        var html = "<div class='col-md-4'>" +
            ...
            "<a href='" + portfolio.see_more + "'class='btn btn-primary'>Go to map</a>" +
            "</div>" +
            "</div>" +
            "</div>";
